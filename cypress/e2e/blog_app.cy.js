describe('Blog app', function () {
  ...
  describe('Login',function() {
    ...
    it('fails with wrong credentials', function() {
      ...
      cy.contains('wrong username or password', { timeout: 10000 }).should('have.css', 'color', 'rgb(255, 0, 0)');
    });
  });
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      cy.get('.success', { timeout: 10000 }).should('have.css', 'color', 'rgb(0, 128, 0)');
    ...
    it('A blog can ONLY be deleted by its creator', function() {
      ...
      cy.contains('new blog new author').parent().find('#removeBtn').should('not.exist');
